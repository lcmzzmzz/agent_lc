...
Three LLM tiers: `FAST_LLM` (quick tasks), `SMART_LLM` (report writing), `STRATEGIC_LLM` (reasoning/research planning). Model format: `provider:model-name` (e.g., `openai:gpt-4.1`, `anthropic:Codex-sonnet-4-6`).
